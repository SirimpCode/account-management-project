...
public class MyUser {
    ...
    @OneToMany(mappedBy = "myUser", fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval = true)
//orphanRemoval 고아제거
    ...
    public void oAuthSignUpSetting(OAuthSignUpDto oAuthSignUpDto) {
        ...
        this.setAsDefaultOrUpdate(oAuthSignUpDto.getProfileImg(), oAuthSignUpDto.getGender());
    }
