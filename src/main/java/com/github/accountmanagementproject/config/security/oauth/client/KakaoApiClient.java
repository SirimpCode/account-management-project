...
import com.github.accountmanagementproject.config.security.oauth.KakaoTokens;
...
import com.github.accountmanagementproject.web.dto.accountAuth.oauth.server.KakaoInfoResponse;
    ...
    public String requestAccessToken(OAuthLoginParams params) {
        ...
        try {
            ...
            throw new CustomBadRequestException.ExceptionBuilder()
                    .systemMessage(badRequest.getMessage())
                    .customMessage("전달된 code가 만료되었습니다.")
                    .request(body.getFirst("code"))
                    .build();
        }
    }
