...
//import com.github.accountmanagementproject.config.security.oauth.RequestOAuthInfoService;
...
//        BigInteger socialId = oAuthInfoResponse.getSocialId();
//
//        MyUser myUser = myUsersJpa.findBySocialId(socialId);
//        if (myUser==null){
////            myUser = myUsersJpa.findBySocialId(socialId+ 3_000_000_000_000_000_000);
//            if(myUser!=null){
//                throw new DuplicateKeyException.ExceptionBuilder()
//                        .customMessage("소셜 계정과 연동 시키다 취소된 계정이 있습니다. 연동 시키겠습니까?")
//                        .request(String.valueOf(myUser.getSocialId()))
//                        .build();
//
//            }
//        }
//        if(myUser!=null){
//            if(myUser.getStatus() == UserStatus.TEMP){
...
//    }
//
//    public ResponseEntity<ResponseDto> connectAccount(boolean isConnect, BigInteger socialId) {
//        MyUser userEntity = myUsersJpa.findBySocialId(socialId);
